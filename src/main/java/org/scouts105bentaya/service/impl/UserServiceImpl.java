...
public class UserServiceImpl implements UserService {
    ...
    public UserServiceImpl(UserRepository userRepository, UserConverter userConverter,
                           @Lazy PasswordEncoder passwordEncoder, LoginAttemptService loginAttemptService,
                           EmailService emailService, RoleRepository roleRepository, RequestService requestService) {
    ...
    public void addNewUserRoleUser(String username, Scout scout) {
        ...
        newUser.setRoles(Collections.singletonList(roleRepository.findByName("ROLE_USER").orElse(null)));
    ...
    public void changePassword(ChangePasswordDto changePasswordDto) {
        ...
        User user = findByUsername(getLoggedUserUsername());
