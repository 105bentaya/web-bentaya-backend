...
public class PartnershipServiceImpl implements PartnershipService {
    ...
    public PartnershipServiceImpl(EmailService emailService) {
    ...
    public void sendPartnershipEmail(PartnershipDto partnershipDto) {
        ...
        emailService.sendSimpleEmail(
                partnershipDto.getEmail(),
                "Copia del correo",
                "Gracias por ponerse en contacto con nosotros para realizar una colaboración. Su información ha" +
                        " sido recibida y nos pondremos en contacto con usted con la mayor brevedad posible." +
