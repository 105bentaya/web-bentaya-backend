...
public class PreScoutPdfService {
    ...
    private void createPreScoutBody(PreScout preScout, PdfPTable table) {
        ...
        int formYear = preScout.getInscriptionYear();
        ...
        creator.addCell("El bloque de prioridad correspondiente es:", preScout.getPriorityAsText(), 12);
        ...
        creator.addCell("Fecha de Solicitud:", preScout.getCreationDate().format(GenericConstants.DATE_TIME_FORMATTER), 12);
    }
