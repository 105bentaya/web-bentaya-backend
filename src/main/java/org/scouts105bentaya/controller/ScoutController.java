...
import org.scouts105bentaya.converter.ScoutConverter;
import org.scouts105bentaya.converter.ScoutUserConverter;
...
public class ScoutController {
    ...
    public ScoutController(ScoutService scoutService, ScoutConverter scoutConverter, ScoutUserConverter scoutUserConverter) {
    ...
    public List<ScoutDto> findAll() {
        log.info("METHOD ScoutController.findAll" + getLoggedUserUsernameForLog());
    ...
    public List<ScoutDto> findAllAndDisabled() {
        log.info("METHOD ScoutController.findAllAndDisabled" + getLoggedUserUsernameForLog());
    ...
    public List<ScoutDto> findAllWithoutImageAuthorization() {
        log.info("METHOD ScoutController.findAllWithoutImageAuthorization" + getLoggedUserUsernameForLog());
    ...
    public List<ScoutDto> findAllByUserGroup() {
        log.info("METHOD ScoutController.findAllByUserGroup" + getLoggedUserUsernameForLog());
    ...
    public List<String> findScoutUsernames(@PathVariable Integer id) {
        log.info("METHOD ScoutController.findScoutUsernames --- PARAMS id: " + id + getLoggedUserUsernameForLog());
    ...
    public ScoutFormUserUpdateDto getScoutUsernamesUpdateDto(
        ...
        log.info("METHOD ScoutController.getScoutUsernamesUpdateDto --- PARAMS scoutId: " + scoutId + getLoggedUserUsernameForLog());
    ...
    public List<ScoutUserDto> findCurrentByUser() {
        log.info("METHOD ScoutController.findCurrentByUser" + getLoggedUserUsernameForLog());
    ...
    public ScoutDto save(@RequestBody ScoutDto scoutDto) {
        log.info("METHOD ScoutController.save" + getLoggedUserUsernameForLog());
        return scoutConverter.convertFromEntity(scoutService.save(scoutDto));
    }

    @PreAuthorize("hasRole('SCOUTER') and @authLogic.userHasGroupId(#scoutDto.groupId) and @authLogic.preScoutHasGroupId(#preScoutId, #scoutDto.groupId)")
    @PostMapping("/{preScoutId}")
    public ScoutDto saveFromPreScout(@RequestBody ScoutDto scoutDto, @PathVariable Integer preScoutId) {
        log.info("METHOD ScoutController.saveFromPreScout --- PARAMS preScoutId: " + preScoutId + getLoggedUserUsernameForLog());
    ...
    public ScoutDto update(@RequestBody ScoutDto scoutDto) {
        log.info("METHOD ScoutController.update --- PARAMS id: " + scoutDto.getId() + getLoggedUserUsernameForLog());
    ...
    public void updateScoutUsers(@PathVariable Integer id, @RequestBody List<String> scoutUsers) {
        log.info("METHOD ScoutController.updateScoutUsers --- PARAMS id: " + id + getLoggedUserUsernameForLog());
    ...
    public void disable(@PathVariable Integer id) {
        log.info("METHOD ScoutController.disable --- PARAMS id: " + id + getLoggedUserUsernameForLog());
    ...
    public void delete(@PathVariable Integer id) {
        log.info("METHOD ScoutController.delete --- PARAMS id: " + id + getLoggedUserUsernameForLog());
